...
def admin_css():
    ...
    return mark_safe(
        ...
        ".w-main, #main, .content-wrapper, .content {"
        "  max-width: 100vw;"
        "  overflow-x: auto !important;"
        "}"
        ".listing { min-width: 0; }"
        ".w-table-wrapper, .w-table {"
        "  overflow-x: auto !important;"
        "  -webkit-overflow-scrolling: touch;"
        "}"
        ".w-table { min-width: 800px; }"
        "footer.w-sticky-footer, .footer { position: static !important; }"
        ".w-dropdown__content, [data-w-dropdown-content], .w-dropdown [data-dropdown-content] {"
        "  max-height: min(70vh, 500px) !important;"
        "  overflow-y: auto !important;"
        "  min-width: 12rem !important;"
        "}"
        ".w-dropdown__content a, .w-dropdown__content button, "
        ".w-dropdown [role='menuitem'], .w-dropdown li a, .w-dropdown li button {"
        ...
        "}"
        "ul.actions, td.actions { position: static !important; }"
